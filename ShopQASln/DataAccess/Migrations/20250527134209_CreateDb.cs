...
namespace DataAccess.Migrations
{
    ...
    public partial class CreateDb : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "Discount",
                columns: new[] { "Id", "Amount", "Code", "EndDate", "IsPercentage", "StartDate", "UsageLimit" },
                values: new object[] { 1, 10m, "SALE10", new DateTime(2025, 6, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), true, new DateTime(2025, 5, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), 100 });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "vana@gmail.com", "hash1", "Customer", "nguyenvana" },
                    { 2, "admin@shopqa.vn", "adminhash", "Admin", "admin" }
                });

            migrationBuilder.InsertData(
                table: "Addresses",
                columns: new[] { "Id", "City", "Country", "Street", "UserId" },
                values: new object[] { 1, "Hà Nội", "Việt Nam", "123 Nguyễn Trãi", 1 });
